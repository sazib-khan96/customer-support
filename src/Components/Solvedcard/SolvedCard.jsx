...
const SolvedCard = ({pross}) => {
    return (
        <div className='p-3 bg-gray-50 text-sm border border-gray-100 shadow-sm my-2 rounded-2xl'>
            ...
            <button className='p-3 w-full bg-green-500 text-white font-semibold rounded-4xl mt-5'>Complete</button>
        </div>
    );
};
